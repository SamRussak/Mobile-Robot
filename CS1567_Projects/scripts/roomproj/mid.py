...
def main():
global depthData, isDepthReady, previousDistance
...
rospy.Subscriber("/camera/depth/image", Image, depthCallback, queue_size=10)
    ...
    while not rospy.is_shutdown():
        ...
        (dist,) = unpack('f', depthData.data[offset] + depthData.data[offset+1] +
        depthData.data[offset+2] + depthData.data[offset+3])
